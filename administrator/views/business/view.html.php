 ...
 * @since  1.6
 */
class Cs_sponsorsViewBusiness extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CS_SPONSORS_TITLE_BUSINESS'), 'business.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_cs_sponsors.business', $this->item->id);
		}
